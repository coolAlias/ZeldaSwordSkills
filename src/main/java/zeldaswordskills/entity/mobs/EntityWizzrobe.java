...
public class EntityWizzrobe extends EntityMob implements IEntityLootable, IEntityTeleport, IEntityVariant, IMagicUser
{
	...
	public int beginSpellCasting(EntityLivingBase target) {
		...
		int castTime = getBaseCastingTime() - (worldObj.difficultySetting * 10);
	...
	public void castRangedSpell(EntityLivingBase target, float range) {
		float difficulty = (float) worldObj.difficultySetting;
		EntityMagicSpell spell = new EntityMagicSpell(worldObj, this, target, 0.8F + (0.25F * difficulty), (float)(14 - worldObj.difficultySetting * 4));
