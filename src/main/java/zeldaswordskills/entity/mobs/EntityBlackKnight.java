...
public class EntityBlackKnight extends EntityDarknut implements IBossDisplayData
{
	...
	protected void applyEntityAttributes() {
		...
		getEntityAttribute(SharedMonsterAttributes.attackDamage).setAttribute(9.0D); // unarmed
	...
	public void addRandomArmor() {
		...
		setCurrentItemOrArmor(ArmorIndex.EQUIPPED_HELM, new ItemStack(Item.helmetChain));
		setCurrentItemOrArmor(ArmorIndex.EQUIPPED_LEGS, new ItemStack(Item.legsChain));
		setCurrentItemOrArmor(ArmorIndex.EQUIPPED_BOOTS, new ItemStack(Item.bootsChain));
