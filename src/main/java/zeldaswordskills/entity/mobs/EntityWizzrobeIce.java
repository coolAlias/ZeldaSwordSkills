...
public class EntityWizzrobeIce extends EntityWizzrobe
{
	public EntityWizzrobeIce(World world) {
		super(world);
	}
	...
	protected void applyEntityAttributes() {
		...
		ZSSEntityInfo.get(this).applyBuff(Buff.RESIST_COLD, Integer.MAX_VALUE, 50);
	...
	protected ItemStack getRareDrop(int rarity, int modifier) {
		...
		if (stack == null) {
			stack = new ItemStack(ZSSItems.arrowIce);
		}
		return stack;
	}
}
