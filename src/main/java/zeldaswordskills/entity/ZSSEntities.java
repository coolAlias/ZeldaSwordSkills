...
import zeldaswordskills.client.render.entity.RenderItemProjectile;
...
public class ZSSEntities
{
	...
	public static void registerRenderers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShot.class, new RenderSnowballFactory(Items.wheat_seeds));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotBomb.class, new RenderSnowballFactory(ZSSItems.bombFlowerSeed));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotCocoa.class, new RenderItemProjectile.Factory<EntitySeedShotCocoa>(Items.dye, 3));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotDeku.class, new RenderSnowballFactory(ZSSItems.dekuNut));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotMelon.class, new RenderSnowballFactory(Items.melon_seeds));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotNetherwart.class, new RenderSnowballFactory(Items.nether_wart));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotPumpkin.class, new RenderSnowballFactory(Items.pumpkin_seeds));
