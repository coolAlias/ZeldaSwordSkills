...
public class ZSSEntities
{
	...
	private static void registerEntities() {
		...
		EntityRegistry.registerModEntity(EntitySeedShotBomb.class, "seedshot_bomb", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
		EntityRegistry.registerModEntity(EntitySeedShotCocoa.class, "seedshot_cocoa", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
		EntityRegistry.registerModEntity(EntitySeedShotDeku.class, "seedshot_deku", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
		EntityRegistry.registerModEntity(EntitySeedShotMelon.class, "seedshot_melon", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
		EntityRegistry.registerModEntity(EntitySeedShotNetherwart.class, "seedshot_netherwart", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
		EntityRegistry.registerModEntity(EntitySeedShotPumpkin.class, "seedshot_pumpkin", ++modEntityIndex, ZSSMain.instance, 64, 10, true);
	...
	public static void registerRenderers() {
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow.png")));
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowBomb.class, new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_bomb.png")));
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowBombFire.class, new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_bomb_fire.png")));
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowBombWater.class, new RenderCustomArrow(new ResourceLocation(ModInfo.ID, "textures/entity/arrow_bomb_water.png")));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotDeku.class, new RenderSnowball(ZSSItems.dekuNut));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotMelon.class, new RenderSnowball(Items.melon_seeds));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotNetherwart.class, new RenderSnowball(Items.nether_wart));
		RenderingRegistry.registerEntityRenderingHandler(EntitySeedShotPumpkin.class, new RenderSnowball(Items.pumpkin_seeds));
