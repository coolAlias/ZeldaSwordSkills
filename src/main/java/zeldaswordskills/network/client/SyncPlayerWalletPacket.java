...
public class SyncPlayerWalletPacket extends AbstractClientMessage<SyncPlayerWalletPacket>
{
	/** NBTTagCompound used to store and transfer the Wallet data */
	private NBTTagCompound compound;

	public SyncPlayerWalletPacket() {}

	public SyncPlayerWalletPacket(ZSSPlayerWallet wallet) {
		compound = new NBTTagCompound();
		wallet.saveNBTData(compound);
	}
