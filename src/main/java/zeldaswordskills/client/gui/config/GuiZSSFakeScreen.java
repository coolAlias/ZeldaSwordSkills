...
public final class GuiZSSFakeScreen extends GuiScreen{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks){
		...
		/*Adjusting the Minecraft screen size (e.g. fullscreen to minimized, or by click-and-drag on the borders
		 * creates a render issue with the background and buttons. This fixes that issue*/
	...
	private final class FakeGuiBuffBar extends GuiBuffBar implements IOverlayButton{
		...
		@Override
		public boolean shouldRender(){return Config.isBuffBarEnabled;}
