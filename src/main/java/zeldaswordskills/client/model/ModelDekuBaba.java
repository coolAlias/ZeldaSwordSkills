...
public class ModelDekuBaba extends ModelDekuBase
{
	...
	public ModelDekuBaba() {
		...
		ATTACK_ANIMATION = new ImmutableList.Builder<IAnimation>()
				.add(new AnimationTargetAngle(stem1, RotationAxis.X, -35.0F, 0, 3, true))
				.add(new AnimationTargetAngle(stem1, RotationAxis.X, 45.0F, 3, 7, true))
				...
				.add(new AnimationTargetAngle(stem2, RotationAxis.X, 45.0F, 0, 3, true))
				.add(new AnimationTargetAngle(stem2, RotationAxis.X, 20.0F, 3, 7, true))
				.add(new AnimationTargetAngle(stem2, RotationAxis.X, 20.0F, 12, 15, true).setAllowOffset(false))
				.add(new AnimationTargetAngle(stem3, RotationAxis.X, 50.0F, 0, 3, true))
				.add(new AnimationTargetAngle(stem3, RotationAxis.X, 15.0F, 3, 7, true))
				...
				.add(new AnimationTargetAngle(head_base, RotationAxis.X, 50.0F, 0, 3, true))
				.add(new AnimationTargetAngle(head_base, RotationAxis.X, 15.0F, 3, 7, true))
		...
		for (EntityAction action : actions) {
			...
			if (frame > 0) {
				...
				if (target != null && (action == EntityDekuBaba.ACTION_ATTACK || action == EntityDekuBaba.ACTION_BOMB)) {
					offset = 0.075F * MathHelper.clamp_float((float)(entity.boundingBox.maxY - target.boundingBox.maxY), -2F, 1.5F);
				}
