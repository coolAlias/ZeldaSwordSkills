...
public class RenderEntitySwordBeam extends Render
{
	...
	private float getRgb(Entity entity) {
		if (entity instanceof EntityThrowable) {
			...
			if (thrower != null && thrower.getEquipmentInSlot(ArmorIndex.EQUIPPED_HELM) != null && thrower.getEquipmentInSlot(ArmorIndex.EQUIPPED_HELM).getItem() == ZSSItems.maskFierce) {
