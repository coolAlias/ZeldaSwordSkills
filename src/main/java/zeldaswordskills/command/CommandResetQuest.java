...
public class CommandResetQuest extends CommandBase
{
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		PlayerUtils.sendTranslatedChat(commandSender, "commands.zssresetquest.all", player.getName());
		if (player != commandSender) {
			PlayerUtils.sendTranslatedChat(player, "commands.zssresetquest.notify.all", commandSender.getName());
		}
	}
