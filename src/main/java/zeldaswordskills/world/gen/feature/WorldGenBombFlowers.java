...
public class WorldGenBombFlowers extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		if (world.isAirBlock(x, y, z) && world.getBlockId(x, y - 1, z) != Block.cobblestone.blockID && ZSSBlocks.bombFlower.canPlaceBlockAt(world, x, y, z)) {
			world.setBlock(x, y, z, ZSSBlocks.bombFlower.blockID, rand.nextInt(8), 2);
			return true;
		}
		return false;
	}
